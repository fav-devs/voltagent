...
function App() {
  ...
  useEffect(() => {
    // Check URL for loggedInUser parameter first (after redirect)
    ...
    if (loggedInUser) {
      ...
      return; // Skip local storage check if found in URL
    }
  ...
  return (
    <div className="flex flex-col h-screen bg-[#121212]">
      {/* Header */}
      <header className="bg-[#1a1a1a] text-white p-4 shadow-lg border-b border-[#333333] flex justify-between items-center">
      ...
      {/* Conditional Rendering: Login or Chat */}
      {!userId ? (
        ...
        // Chat View
        <>
          {/* Error Display (moved here for chat view) */}
          {streamError && (
              ...
              {messages.length === 0 ? (
                <div className="text-center text-[#71717a] my-8 p-8 border border-dashed border-[#333333] rounded-lg">
                  ...
                  <p className="text-lg text-[#d4d4d8]">
                    Connected as{" "}
                    <span className="font-mono bg-[#27272a] px-2 py-0.5 rounded text-sm">
                      {userId}
                    </span>
                  </p>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <form onSubmit={handleSubmit} className="flex items-center space-x-2">
                <input
                  ...
                  placeholder={
                    isStreaming ? "Waiting for response..." : "Message Google Drive Assistant..."
                  }
                />
                <button
                  type="submit"
